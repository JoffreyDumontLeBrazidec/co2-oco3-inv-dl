...
list_test_indices_considered    = list(shuffleIndices [data.N_trainingData+data.N_validationData:])
...
test_predictions                = PDM_model.predict (f_test)
binary_test_predictions         = np.around (test_predictions)
