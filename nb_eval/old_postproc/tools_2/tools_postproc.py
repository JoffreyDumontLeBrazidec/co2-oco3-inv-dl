...
#------------------------------------------------------------------------
# setFigure_2_2_2_2
def setFigure_2_2_2_2 (pad_w_int=0.35, pad_h_int=0.33):
    ...
    # (w, h) for the figure
    fig_w       = pad_w_ext + ax_w + pad_w_int + ax_w + pad_w_ext
    fig_h       = pad_h_ext + ax_h + pad_h_int + ax_h + pad_h_int + ax_h + pad_h_int + ax_h + pad_h_ext
    ...
    ax5         = figure.add_axes([ax1_x, ax3_y, ax_dx, ax_dy])
    ax6         = figure.add_axes([ax2_x, ax3_y, ax_dx, ax_dy])
    ax7         = figure.add_axes([ax1_x, ax4_y, ax_dx, ax_dy])
    ax8         = figure.add_axes([ax2_x, ax4_y, ax_dx, ax_dy])
