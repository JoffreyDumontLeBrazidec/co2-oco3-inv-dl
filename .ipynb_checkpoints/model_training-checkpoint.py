...
class Model_training_manager:
    """Train CNN models for segmentation, inversion tasks."""
    ...
    def prepare_data(self, cfg: DictConfig) -> None:
        ...
        self.data = Data(os.path.join(cfg.data.path.directory,
                                      cfg.data.path.train.name,
                                      cfg.data.path.train.nc),
                         os.path.join(cfg.data.path.directory,
                                      cfg.data.path.valid.name,
                                      cfg.data.path.valid.nc),
                         cfg.split.train.ratio,
                         cfg.split.type,
                        )
                         
        self.data.prepare_input(cfg.data.input.chan_1, cfg.data.input.chan_2, cfg.data.input.chan_3, cfg.data.input.dir_seg_models)
